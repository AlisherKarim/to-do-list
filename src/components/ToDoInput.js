...
export default class ToDoInput extends Component {
    ...
    render() {
        const { value, dateValue, handleSubmit, handleChange, dateChangeHandler} = this.props;
        return (
            <div>
                <form className = "form" onSubmit = {handleSubmit}>
                    <div className = "container form-group">
                        ...
                        <div className='row'>
                            <FullWidthTextField className = 'col-8' handleChange = {handleChange} id = "todoInput" name = "todoInput" type = "text" placeholder = "Enter the ToDo" value = {value}/>
                            ...
                            <div className = 'col-4'>
                                <BasicDateTimePicker dateValue={dateValue} dateChangeHandler = {dateChangeHandler}/>
                            </div>
                        </div>
                    </div>
